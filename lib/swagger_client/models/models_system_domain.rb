...
module SwaggerClient
  class ModelsSystemDomain
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dkimConfig')
        self.dkim_config = attributes[:'dkimConfig']
      end

      if attributes.has_key?(:'dkimVerified')
        self.dkim_verified = attributes[:'dkimVerified']
      end
      ...
      if attributes.has_key?(:'mailboxVerified')
        self.mailbox_verified = attributes[:'mailboxVerified']
      end
      ...
      if attributes.has_key?(:'spfVerified')
        self.spf_verified = attributes[:'spfVerified']
      end
    ...
    def hash
      [created, dkim, dkim_config, dkim_verified, id, mailbox_verified, name, spf, spf_verified, track, track_verified].hash
    end
