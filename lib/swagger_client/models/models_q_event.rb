...
module SwaggerClient
  class ModelsQEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eventMetadata')
        self.event_metadata = attributes[:'eventMetadata']
      end
    ...
    def hash
      [account_id, event_id, event_metadata, from, groups, ip_id, message_id, message_type, sub_account_id, submitted_at, to, type].hash
    end
