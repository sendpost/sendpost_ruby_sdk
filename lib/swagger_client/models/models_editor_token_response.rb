...
module SwaggerClient
  class ModelsEditorTokenResponse
    ...
    attr_accessor :asclient_id

    attr_accessor :asregion
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'as:client_id')
        self.asclient_id = attributes[:'as:client_id']
      end

      if attributes.has_key?(:'as:region')
        self.asregion = attributes[:'as:region']
      end
    ...
    def hash
      [_expires, _issued, access_token, asclient_id, asregion, expires_in, refresh_token, token_type, user_name].hash
    end
