...
module SwaggerClient
  class ModelsAlertRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entityValue')
        self.entity_value = attributes[:'entityValue']
      end
      ...
      if attributes.has_key?(:'slackUrl')
        self.slack_url = attributes[:'slackUrl']
      end
    ...
    def hash
      [active, emails, entity_type, entity_value, label, member, name, notification_type, parameter, provider, slack_url, threshold].hash
    end
