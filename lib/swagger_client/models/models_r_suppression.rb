...
module SwaggerClient
  class ModelsRSuppression
    ...
    def self.swagger_types
      {
        :'hard_bounce' => :'Array<ModelsSuppressionEmail>',
        :'manual' => :'Array<ModelsSuppressionEmail>',
        :'spam_complaint' => :'Array<ModelsSuppressionEmail>',
        :'unsubscribe' => :'Array<ModelsSuppressionEmail>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hardBounce')
        if (value = attributes[:'hardBounce']).is_a?(Array)
      ...
      if attributes.has_key?(:'spamComplaint')
        if (value = attributes[:'spamComplaint']).is_a?(Array)
