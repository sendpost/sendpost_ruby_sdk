...
module SwaggerClient
  class ModelsDomain
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'returnPath')
        self.return_path = attributes[:'returnPath']
      end

      if attributes.has_key?(:'returnPathVerified')
        self.return_path_verified = attributes[:'returnPathVerified']
      end
