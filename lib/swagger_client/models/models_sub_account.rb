...
module SwaggerClient
  class ModelsSubAccount
    ...
    def self.swagger_types
      {
        ...
        :'name' => :'String',
        :'smtp_auths' => :'Array<ModelsSMTPAuth>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'smtpAuths')
        if (value = attributes[:'smtpAuths']).is_a?(Array)
    ...
    def hash
      [api_key, created, id, labels, name, smtp_auths, type].hash
    end
