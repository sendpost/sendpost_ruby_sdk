...
module SwaggerClient
  class ModelsAccountIPPool
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'routingMetaData')
        self.routing_meta_data = attributes[:'routingMetaData']
      end
    ...
    def hash
      [created, id, ips, name, routing_meta_data, routing_strategy, type].hash
    end
