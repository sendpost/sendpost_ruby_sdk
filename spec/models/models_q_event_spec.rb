...
# Unit tests for SwaggerClient::ModelsQEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModelsQEvent' do
  before do
    # run before each test
    @instance = SwaggerClient::ModelsQEvent.new
  end
  ...
  describe 'test an instance of ModelsQEvent' do
    it 'should create an instance of ModelsQEvent' do
      expect(@instance).to be_instance_of(SwaggerClient::ModelsQEvent)
    end
  end
